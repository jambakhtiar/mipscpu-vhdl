...
HD_PWD='/home/jam/Downloads/MIPScpu/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Basic_Timer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Basic_Timer.tcl
